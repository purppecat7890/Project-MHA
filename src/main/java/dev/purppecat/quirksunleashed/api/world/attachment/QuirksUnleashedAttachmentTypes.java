...
public class QuirksUnleashedAttachmentTypes {
    ...
    // Fighting Styles
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<QuirksData>> QUIRKS = ATTACHMENT_TYPES.register("quirks", () -> AttachmentType.builder(() -> new QuirksData()).serialize(QuirksData.CODEC).sync(QuirksData.STREAM_CODEC).copyOnDeath().build());
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<Boolean>> QUIRK_ACTIVATED = ATTACHMENT_TYPES.register("quirk_activated", () -> AttachmentType.builder(() -> false).build());
